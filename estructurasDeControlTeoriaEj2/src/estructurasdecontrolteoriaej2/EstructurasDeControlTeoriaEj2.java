...
tipo de motor de una bomba para mover fluidos). Definir una variable tipoMotor y permitir que el 
usuario ingrese un valor entre 1 y 4. El programa debe mostrar lo siguiente:
 ...
 */
package estructurasdecontrolteoriaej2;

import java.util.Scanner;


public class EstructurasDeControlTeoriaEj2 {
